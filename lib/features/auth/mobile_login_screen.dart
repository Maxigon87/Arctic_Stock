...
class _MobileLoginScreenState extends State<MobileLoginScreen> {
  ...
  Future<void> _checkStatus() async {
    ...
    if (negocioId != null || _authService.isAuthenticated) {
      ...
      if (_dbService.activeUserId != null) {
        ...
        children: [
          ...
          if (_showRegisterForm) ...[
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                prefixIcon: Icon(Icons.business_outlined, color: isDark ? Colors.white60 : const Color(0xFF64748B)),
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              prefixIcon: Icon(Icons.email_outlined, color: isDark ? Colors.white60 : const Color(0xFF64748B)),
                ...
                children: [
                  ...
                  Expanded(
                    ...
                    child: DropdownButtonFormField<int>(
                      ...
                      style: GoogleFonts.manrope(color: textColor, fontWeight: FontWeight.w600),
